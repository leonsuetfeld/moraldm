...
# and the mean of the modality levels, right? and those values can be
# interpreted as population means, correct?
# ----------------------------------------------------------------------
...
# essentially add the estimated value to the main effects, while making
# predictions for abstraction==0 (text), we would subtract them, correct?
# (at least I think that's how it should be, but I'm not sure if with the
# current effect coding we would have to add/ subtract 0.5*parameter...?)
# ----------------------------------------------------------------------
...
# ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
# these are interaction parameters and would be added if abstr==1 and
# modal==1 at the same time, and subtracted wenn abstr==0 && modal==0,
# correct?
# ----------------------------------------------------------------------

# questions / to do:
# - in the model it's "visonset_left:abstraction" -- why not "visonset_left*abstraction"?
